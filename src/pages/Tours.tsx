...
const Tours = () => {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f7]">
      ...
      {/* Filters Bar */}
      <section className="sticky top-16 sm:top-20 z-30 bg-white border-y border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 py-3 sm:py-4">
          <div className="flex flex-col gap-3 sm:gap-4 lg:flex-row lg:items-center lg:justify-between">
            {/* Category Tabs */}
            <div className="flex items-center gap-1 overflow-x-auto pb-2 lg:pb-0 -mx-1 px-1 scrollbar-hide">
              {categories.map((cat) => (
                <button
                  key={cat.id}
            ...
            <div className="relative w-full lg:max-w-xs">
              ...
              <input
                ...
                className="w-full h-10 sm:h-11 pl-10 sm:pl-11 pr-4 bg-gray-50 border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all text-sm"
              />
            </div>
          </div>
        </div>
      ...
      {/* Results Info */}
      <section className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-16 pt-6 sm:pt-8">
      ...
      {/* Tours Grid */}
      <section className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-16 py-8 sm:py-12 pb-16 sm:pb-24">
        {filteredTours.length === 0 ? (
          <div className="text-center py-12 sm:py-20 bg-white border border-gray-100">
            <div className="text-4xl sm:text-6xl mb-4">🔍</div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2 font-serif">No journeys found</h3>
